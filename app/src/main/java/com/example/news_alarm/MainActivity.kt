...
//import com.example.news_alarm.ui.settings.SettingsScreen
//
//// 데이터 모델
//data class NewsItem(
//    val title: String,
...
//        initializeDefaultPrefs(applicationContext)
//        val prefs = getSharedPreferences("news_prefs", Context.MODE_PRIVATE)
//        val interval = prefs.getLong("check_interval_minutes", 15L) // 기본값 15분
//
//        scheduleNewsChecker(applicationContext, interval)
//
//        setContent {
//            MaterialTheme {
//                AppNavigation()
...
//}
//
//private fun initializeDefaultPrefs(context: Context) {
//    val prefs = context.getSharedPreferences("news_prefs", Context.MODE_PRIVATE)
//
...
//            .putBoolean("initialized", true) // ✅ 초기화 플래그
//            .apply()
//    }
//}
...
import androidx.activity.ComponentActivity
import androidx.activity.compose.setContent
import com.example.news_alarm.navigation.AppNavigation
import com.example.news_alarm.worker.initializeDefaultPrefs
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val interval = prefs.getLong("check_interval_minutes", 15L)
        scheduleNewsChecker(applicationContext, interval)
